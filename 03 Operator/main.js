...
console.log('The Total Result is', additionResult); // addition operator
...
console.log('The Modulus Result is',modulusResult); //modulus operator  

var valeOfIncrement = 35;
valeOfIncrement +=10; 
console.log(valeOfIncrement); 

var valueOfDecrement = 45; 
valueOfDecrement -= 10;
console.log(valueOfDecrement);